...
DiffusionSlover::DiffusionSlover(int h, int w, int mode)
{
	...
	std::stringstream diffuser_file_new;
	...
	while (getline(diffuser_file, line))
	{
		if (line.substr(0, 7) == "Reshape")
		{
			...
			{
			case 0:
				line = line.substr(0, line.size() - 4) + std::to_string(w * h / 8 / 8);
				break;
			case 1:
				line = line.substr(0, line.size() - 7) + std::to_string(w / 8) + " 2=" + std::to_string(h / 8);
				break;
			case 2:
				line = line.substr(0, line.size() - 4) + std::to_string(w * h / 8 / 8);
				break;
			case 3:
				...
				break;
			case 4:
				line = line.substr(0, line.size() - 4) + std::to_string(w * h / 2 / 2 / 8 / 8);
				break;
			case 5:
				line = line.substr(0, line.size() - 7) + std::to_string(w / 2 / 8) + " 2=" + std::to_string(h / 2 / 8);
				break;
			case 6:
				line = line.substr(0, line.size() - 4) + std::to_string(w * h / 2 / 2 / 8 / 8);
				break;
			case 7:
				...
				break;
			case 8:
				line = line.substr(0, line.size() - 3) + std::to_string(w * h / 4 / 4 / 8 / 8);
				break;
			case 9:
				line = line.substr(0, line.size() - 7) + std::to_string(w / 4 / 8) + " 2=" + std::to_string(h / 4 / 8);
				break;
			case 10:
				line = line.substr(0, line.size() - 3) + std::to_string(w * h / 4 / 4 / 8 / 8);
				break;
			case 11:
				...
				break;
			case 12:
				line = line.substr(0, line.size() - 2) + std::to_string(w * h / 8 / 8 / 8 / 8);
				break;
			case 13:
				line = line.substr(0, line.size() - 5) + std::to_string(w / 8 / 8) + " 2=" + std::to_string(h / 8 / 8);
				break;
			case 14:
				line = line.substr(0, line.size() - 3) + std::to_string(w * h / 4 / 4 / 8 / 8);
				break;
	...
	net.load_param_mem(diffuser_file_new.str().c_str());
